...
import type { switcherType, elementType } from "@/app/types/homePage.type";
				...
				{data
					...
					.map(element => (
						<div
							...
							key={element.id}
							className={cn(
								"bg-no-repeat bg-center bg-cover my-12 grayscale transition-all duration-300 rounded-full h-20 w-20 min-h-10 min-w-10 cursor-pointer",
